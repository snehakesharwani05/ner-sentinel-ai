...
// 4. A* Search Engine with Admissible Heuristic & Elliptical Corridor Bounding
function runAStar(nodesDict, adjList, startNode, goalNode, options = {}) {
  ...
  const cameFrom = {};
  const gScore = {}; // Cost from start along best known path (in minutes)
  const fScore = {}; // Estimated total cost: gScore + admissible heuristic
