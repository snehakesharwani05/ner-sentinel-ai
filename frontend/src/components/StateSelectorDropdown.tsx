...
import { NER_STATES, ALL_NER_REGION, NERState, TOTAL_NER_HUBS_COUNT } from "../constants/nerLocations";
...
export const StateSelectorDropdown: React.FC<Props> = ({ activeZone = "ALL", onSelectZone }) => {
  ...
  const currentState: NERState = isAll
    ? ALL_NER_REGION
