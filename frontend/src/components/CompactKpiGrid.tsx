...
export interface KpiMetrics {
  ...
  accessibleHubs: number;
  totalHubs: number;
  severedPasses: number;
  cautionPasses: number;
  weatherWatchLevel: string;
  maxSoilSaturation: number;
  activeConvoys: number;
  reroutedConvoys: number;
}

export const CompactKpiGrid: React.FC<{ metrics: KpiMetrics }> = ({ metrics }) => {
  const safeMetrics: KpiMetrics = {
