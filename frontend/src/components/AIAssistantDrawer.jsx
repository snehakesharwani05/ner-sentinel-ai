...
const STRICT_REFUSAL_MESSAGE = "I am Bhumika, your AI Operations Commander. I can only assist you with the 4 core sections of NER Sentinel AI: Command Dashboard, Convoy Telematics (AIS-140), Route Intelligence, Hazard Simulation Studio, and Field Incident Report. How can I help you within these operations?";
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      sender: 'ai',
      text: `Namaste! I am **Bhumika**, your AI Operations Commander for **NER Sentinel AI**. I am here to guide you across our 4 core sections—Command Dashboard, Convoy Telematics (AIS-140), Route Intelligence, and Hazard Simulation Studio & Field Incident Report. How can I assist your mission today?`,
