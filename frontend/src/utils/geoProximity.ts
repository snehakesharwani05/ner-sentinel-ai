 ...
 */
export function isWithinRadius(center: GeoPoint, target: GeoPoint, radiusKm: number): boolean {
 ...
 */
export function extractDisruptionCoordinates(disruption: any): GeoPoint | null {
